...
variable "name" {
  default = "apache_superset_group"
}

######## Security group
resource "alicloud_security_group" "group" {
  name        = "sg_apache_superset"
  description = "Security group for apache superset"
...
resource "alicloud_security_group_rule" "allow_http_9090" {
  type              = "ingress"
  ip_protocol       = "tcp"
  nic_type          = "intranet"
  policy            = "accept"
...
resource "alicloud_security_group_rule" "allow_http_5432" {
  type              = "ingress"
  ip_protocol       = "tcp"
  nic_type          = "intranet"
  policy            = "accept"
...
resource "alicloud_instance" "instance" {
  ...
  ##### Use the Superset image in Marketplace:
  # https://marketplace.alibabacloud.com/products/56698003/Apache_em_Superset_em_on_Ubuntu-sgcmjj00025684.html
  instance_type           = "ecs.c5.large" # 2core 4GB
  system_disk_category    = "cloud_ssd"
  system_disk_name        = "apache_superset_system_disk"
  system_disk_size        = 40
  system_disk_description = "apache_superset_system_disk"
  image_id                = "m-t4n10vdkrs1r0ibfj2s4"
  instance_name           = "apache_superset"
