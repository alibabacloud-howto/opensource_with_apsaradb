...
resource "alicloud_db_account_privilege" "privilege_0" {
  instance_id  = alicloud_db_instance.instance_0.id
  account_name = alicloud_rds_account.account_0.name
  privilege    = "DBOwner"
  db_names     = alicloud_db_database.db0.*.name
}

resource "alicloud_db_account_privilege" "privilege_1" {
  instance_id  = alicloud_db_instance.instance_1.id
  account_name = alicloud_rds_account.account_1.name
  privilege    = "DBOwner"
  db_names     = alicloud_db_database.db1.*.name
}

resource "alicloud_db_account_privilege" "privilege_2" {
  instance_id  = alicloud_db_instance.instance_2.id
  account_name = alicloud_rds_account.account_2.name
  privilege    = "DBOwner"
  db_names     = alicloud_db_database.db2.*.name
}

resource "alicloud_db_account_privilege" "privilege_3" {
  instance_id  = alicloud_db_instance.instance_3.id
  account_name = alicloud_rds_account.account_3.name
  privilege    = "DBOwner"
