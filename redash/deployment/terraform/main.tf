...
resource "alicloud_instance" "instance" {
  ...
  system_disk_name        = "redash_system_disk"
  system_disk_size        = 40
  system_disk_description = "redash_system_disk"
  image_id                = "ubuntu_20_04_x64_20G_alibase_20210623.vhd"
  instance_name           = "redash"
